setwd("B:/projects/PycharmProjects/Akagera/data/classification")
...
colnames(class_mean_vectors) <- c("SR_B2", "SR_B3", "SR_B4", "SR_B5", "SR_B6", "SR_B7")
